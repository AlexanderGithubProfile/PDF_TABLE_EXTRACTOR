...
def relative_to_assets(path: str) -> Path:
    """Функция для получения пути к ресурсам относительно текущего файла."""
    ASSETS_PATH = Path(__file__).parent / "assets"
    return ASSETS_PATH / Path(path)

# Логирование
class TextHandler(logging.Handler):
    """Логирование текстовых сообщений в виджет лейбла"""
...
class App(ctk.CTk, TkinterDnD.DnDWrapper):
    ...
    def __init__(self, mode: str, *args, **kwargs):
        ...
        self.file_ = tk.Entry(self.entry_frame, bg='white' if self.mode == 'Light' else 'black',
                                                    borderwidth=0,
    ...
    # Создание директории для ввода и копирование файла
    def make_dir_and_start_process(self, file_path: str) -> None:
    ...
    # Получение пути файла из Drag & Drop
...
def main() -> None:
    ...
    # Изменение цвета заголовка окна в зависимости от платформы
    if sys.platform == 'win32':
